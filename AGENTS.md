...
Aakd is an open-source, self-hostable, AI-native Contract Lifecycle Management platform. It is publicly hosted at `aaked-app/aakd` and is currently released as v1.3.0.
