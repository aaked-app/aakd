...
vi.mock("@/lib/db/client", () => {
  const prisma: any = {
    ...
    documentSnapshot: { findMany: vi.fn().mockResolvedValue([]), findUnique: vi.fn(), create: vi.fn(), delete: vi.fn(), deleteMany: vi.fn().mockResolvedValue({ count: 0 }) },
    contractComment: { findMany: vi.fn().mockResolvedValue([]), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn() },
