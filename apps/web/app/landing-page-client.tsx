...
function FinalCTA() {
  const t = useTranslations("landing")
  return (
    <section className="border-y border-black bg-[#245442] py-14 sm:py-20"><div className="mx-auto grid max-w-[88rem] gap-8 px-4 sm:px-6 lg:grid-cols-12 lg:items-end lg:gap-6 lg:px-10"><div className="lg:col-span-8"><h2 className="max-w-4xl text-balance font-[var(--font-sora)] text-3xl font-semibold tracking-[-0.04em] text-white sm:text-5xl">{t("finalCta.title")}</h2><p className="mt-4 max-w-2xl text-base leading-7 text-[#dbe6df]">{t("finalCta.subtitle")}</p></div><div className="flex flex-col gap-3 sm:flex-row lg:col-span-4 lg:justify-end"><Link href="/register" className="inline-flex min-h-11 items-center justify-center bg-white px-5 text-sm font-bold text-[#17211c] hover:bg-[#edf2ee] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#245442]">{t("finalCta.primary")}</Link><Link href={REPOSITORY_URL} className="inline-flex min-h-11 items-center justify-center gap-2 border border-white/60 px-5 text-sm font-bold text-white hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"><ExternalLink className="size-4" aria-hidden="true" />{t("finalCta.secondary")}</Link></div></div></section>
  )
}
