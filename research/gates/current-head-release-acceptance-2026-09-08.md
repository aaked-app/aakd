...
| Post-merge public `main` verification | `PASS_REMOTE` | Run `34195739421` on public `main` passed all required jobs, including functional browser E2E, without a rerun. The previously observed E2E failure was not reproduced in six local targeted repetitions or this post-merge run. |
